...
DB_CONTAINER_NAME="code-kshetra-postgres"
...
docker run --name $DB_CONTAINER_NAME -e POSTGRES_PASSWORD=$DB_PASSWORD -e POSTGRES_DB=code-kshetra -d -p 5432:5432 docker.io/postgres
